...
def servicos(request, cod_servico=None, cod_produto=None):
    ...
    if request.method == "POST":
        ...
        if action == "Lançar Serviço":
            ...
            c.drawString(width - 180, 17, "__________")  # Escrever o título no canto esquerdo
            c.drawString(width - 150, 15, "DEV")  # Escrever o título no canto esquerdo
            c.drawString(width - 135, 17, "__________")  # Escrever o título no canto esquerdo
