...
def dashboard(request):
    ...
    for item in list(compras) + list(folha) + list(custos_ex):  # Agrupando todas as fontes de custo
        # if item.vencimento or item.pg_salario:  # Garante que 'vencimento' não seja None
        ...
        resumo_custos[chave]["total"] += item.total  # Soma os valores de cada fonte
