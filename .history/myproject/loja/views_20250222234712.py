...
def servicos(request, cod_servico=None, cod_produto=None):
    ...
    if request.method == "POST":
        ...
        if action == "Lançar Serviço":
            ...
            c.drawString(width - 200, 30, "________")  # Escrever o título no canto esquerdo
            c.drawString(width - 180, 30, "DEV")  # Escrever o título no canto esquerdo
            c.drawString(width - 160, 30, "________")  # Escrever o título no canto esquerdo
            c.setFont("Helvetica-Bold", 9)  # Fonte maior para o título
