            ...
            if produtos:
                ...
                for produto in produtos:
                    ...
                    if y < 100:  # Se y for menor que 100, cria uma nova página
                        ...
                        c.setFont("Helvetica-Bold", 13)
                        c.drawCentredString(width / 2, y, "Produtos Vendidos (Continuação OS {os})")
                        y -= 25
                        c.setFont("Helvetica", 10)
                ...
                y -= 10  # Espaço extra após a tabela de produtos
                # Exibe os totais abaixo da tabela
                c.drawString(coluna_cod_produto, y, f"{total_itens} ITENS")
            ...
            if servicos:
                ...
                for servico in servicos:
                    if y < 100:  # Se não há mais espaço, nova página
                        ...
                        y = height - 50
                        c.setFont("Helvetica-Bold", 13)
                        c.drawCentredString(width / 2, y, "Serviços Realizados (Continuação OS {os})")
                        y -= 25
                        c.setFont("Helvetica", 10)
