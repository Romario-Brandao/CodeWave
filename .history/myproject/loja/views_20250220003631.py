    ...
    if request.method == "POST":
        ...
        if action == "Lançar Serviço":
            ...
            if produtos:
                ...
                y -= 32  # Espaço extra após a tabela de produtos
            ...
            c.setFont("Helvetica-Bold", 13)
            c.drawCentredString(width / 2, y, "Parcelas da Venda / Serviços")
            y -= 25
            ...
            c.drawString(c_forma_pg, y, "Forma de Pag")
            c.drawRightString(c_valor + 50, y, "Valor")
            c.drawRightString(c_vencimento + 50, y, "Vencimento")

            # c.drawString(40, y, f"{'Parcela':<10}{'Forma de Pagamento':<20}{'Valor':>12}{'Vencimento':>15}")
            y -= 10 
            for i in range(1, quant_parcelas + 1):
                parcela = dados.get(f'parcela_{i}', '')
                forma_pg = dados.get('forma_pg', '')
                ...
                c.drawString(c_parcela, y, f"{parcela:<45}")s
