...
def servicos(request, cod_servico=None, cod_produto=None):
    ...
    if request.method == "POST":
        ...
        if action == "Lançar Serviço":
            ...
            if produtos:
                ...
                c.drawCentredString(width / 2, y, "Produtos Vendidos")
                y -= 25
                ...
                coluna_quantidade = 240
                coluna_valor_unitario = 295
                coluna_desconto = 370
                coluna_total = 430
                ...
                c.drawString(coluna_quantidade, y, "Quantidade")
                c.drawString(coluna_valor_unitario, y, "Valor Unitário")
                c.drawString(coluna_desconto, y, "Desconto")
                c.drawString(coluna_total, y, "Total")
                ...
                for produto in produtos:
                    if y < 100:  # Se y for menor que 100, cria uma nova página
                        ...
                        c.setFont("Helvetica-Bold", 13)
                        c.drawCentredString(width / 2, y, "Produtos Vendidos (Continuação)")
                        y -= 25
                        c.setFont("Helvetica", 10)
                ...
                y -= 25  # Espaço extra após a tabela de produtos

            # Garante que os serviços comecem em uma nova página se necessário
            if servicos:
                ...
                c.setFont("Helvetica-Bold", 13)
                c.drawCentredString(width / 2, y, "Serviços Realizados")
                y -= 25
                c.setFont("Helvetica-Bold", 10)
    ...
    # coluna_total = 420
                ...
                coluna_id = 40
                coluna_servico = 75
                # coluna_servico_valor = 400
                # coluna_desconto = 600
                coluna_total = 235
                coluna_profissional = 285

                c.drawString(coluna_id, y, "Cod")
                c.drawString(coluna_servico, y, "Serviço")
                c.drawString(coluna_total, y, "Total")
                c.drawString(coluna_profissional, y, "Profissional")
                ...
                for servico in servicos:
                    if y < 100:  # Se não há mais espaço, nova página
                        ...
                        y = height - 50
                        c.setFont("Helvetica-Bold", 13)
                        c.drawCentredString(width / 2, y, "Serviços Realizados (Continuação)")
                        y -= 25
                        c.setFont("Helvetica", 10)
                    ...
                    c.drawString(coluna_total, y, f"{servico.total:>15.2f}")
                    c.drawString(coluna_profissional, y, f"{servico.profissional.nome:<25}")
