    ...
    if request.method == "POST":
        ...
        if dados.get('acao') == 'Pagamento Salário':
            ...
            for item in funcionarios:
                valor_key = f'valor_{item.id}'
                salario = Decimal(dados.get(valor_key, '0'))
        
        # if salario == 0:
        #     continue  # Ignora funcionários sem salário informado
        
        obs_key = f'obs_{item.id}'
        obs = dados.get(obs_key, "")
