    ...
    for item in folha:
        if item.mes_ano_competencia:
            ...
            if len(partes) == 2:  # Garantimos que há mês e ano
                ...
                print(f"Processando folha: {item.mes_ano_competencia} | Mês: {mes}, Ano: {ano}, VT: {vt}, VA: {va}, FGTS: {fgts}, Salário: {salario}, Desconto VT: {desconto_vt}")
        ...
        print(f"Resumo de custos: {resumo_custos}")  # Verificação do cálculo final
