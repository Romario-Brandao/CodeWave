...
def dashboard(request):
    ...
    for item in vendas:
        if item.vencimento:
            ...
            resumo_vendas[chave]["quantidade"] += 1
    ...
    resumo_custos = defaultdict(lambda: {"total": 0, "mes": "", "ano": ""})
    ...
    #             # resumo_custos[chave]["total"] += item.salario_bruto
    #             resumo_custos[chave]["mes"] = mes
    #             resumo_custos[chave]["ano"] = ano


    resumo_custos = [{"mes": v["mes"], "ano": v["ano"], "total": v["total"]} for v in resumo_custos.values()]
    ...
    return render(request, 'dashboard.html', {
        ...
        'folha':folha,
        'custos_ex':custos_ex, 'resumo_custos':resumo_custos
    })
