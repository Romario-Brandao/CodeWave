...
def dashboard(request):
    ...
    for item in folha:
        ...
        if item.mes_ano_competencia and "-" in item.mes_ano_competencia:
            partes = item.mes_ano_competencia.split("-")
            
            if len(partes) == 2:  # Garantimos que há ano e mês
                ano, mes_num = partes  # Exemplo: "2024-03" → ano="2024", mes_num="03"
                mes = list(meses.values())[int(mes_num) - 1]  # Convertendo "03" para "MAR"
