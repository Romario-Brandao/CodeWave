...
@login_required(login_url='/')
def contas_pagaraaaaaaa(request, id_titulo=None, data_inicial=None, data_final=None, filtro='todos', ordenar_por='os'):
    relatorio = []
    dados_caixa = {}
    periodo = {}
    if request.method == "POST":
        ...
        filtro = request.POST.get('titulos_pg', 'nao')
        ordenar_por = request.POST.get('ordenar_por', 'vencimento')
        # id_titulo = request.POST.get('id_titulo')
        data_inicial = request.POST.get('data_inicial')
        data_final = request.POST.get('data_final')
        try:
