...
def servicos(request, cod_servico=None, cod_produto=None):
    ...
    if request.method == "POST":
        ...
        if action == "Lançar Serviço":
            ...
            if ts > 0:
                ...
                for servico in servicos:
                    if y < 100:  # Se não há mais espaço, nova página
                        ...
                        # c.setFillCoslorRGB(0.0, 0.2, 0.6)  # Azul Cobalto	
            ...
            y2 = y
            y =150
            c.drawString(70, y, "_______________________________________________________________________________") 
            ...
            y = y2
            if y < 500:  # Se não há mais espaço, nova página
                c.setFont("Helvetica-Bold", 15)
                # c.setFillColorRGB(0, 0, 0.4)  #
                # c.setFillColorRGB(0.0, 0.2, 0.3)  # Azul Petróleo	
                # c.setFillColorRGB(0.0, 0.0, 0.3)  # Azul Marinho Escuro	
                ...
                y = height - 50
                c.setFont("Helvetica-Bold", 13)
                c.drawString(70, y, "Recebimento (Continuação OS {os})")
                y -= 25
