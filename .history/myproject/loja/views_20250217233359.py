    ...
    if request.method == "POST":
        ...
        if action == "Lançar Serviço":
            ...
            if tp > 0:
                ...
                for produto in produtos:
                    c.drawString(40, y, f"{produto.produto.cod_produto:<10}{produto.produto.nome:<45}{produto.quantidade:>8.3f}{produto.produto.preco_venda:>18.2f}{produto.desconto:>18.2f}{produto.total:>15.2f}")
                    y -= 8
