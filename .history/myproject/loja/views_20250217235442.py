    ...
    if request.method == "POST":
        ...
        if action == "Lançar Serviço":
            ...
            if tp > 0:
                ...
                coluna_nome_produto = coluna_cod_produto + 10   # Largura para o código do produto
                ...
                for produto in produtos:
                    ...
                    c.drawString(10, y, f"{produto.produto.cod_produto:<10}")
                    c.drawString(45, y, f"{produto.produto.nome:<45}")
                    c.drawString(8, y, f"{produto.quantidade:>8.3f}")
                    c.drawString(18, y, f"{produto.produto.preco_venda:>18.2f}")
                    c.drawString(18, y, f"{produto.desconto:>18.2f}")
                    c.drawString(18, y, f"{produto.total:>18.2f}")
